...
const header = '// DO NOT EDIT: this is file is automatically generated by get_assets_properties script\n';
...
const ionEndpoints = Promise.all(
  ionAssetIds.map((id) => fetchIon(`https://api.cesium.com/v1/assets/${id}/endpoint`)),
).then((responses) => Promise.all(responses.map((response) => response.json())));

// only keep the 3d tiles tilesets and request the tileset.json files
const ionTilesets = ionEndpoints
  .then((responses) => responses.filter((response) => response.type === '3DTILES'))
