  ...
  render() {
    ...
    return html`
      ...
      <div class="ngm-geom-edit-coord-input">
        <div class="ngm-input">
          <input
            class="ngm-coord-x-input"
            style="${styleMap({
              fontSize: this.coordsType === 'lv95' ? '14px' : '16px',
            })}"
            step=${this.coordsType === 'lv95' ? 0.1 : 0.001}
            type="number"
            .value=${this.xValue.toFixed(1)}
        ...
        <div class="ngm-input">
          <input
            class="ngm-coord-y-input"
            style="${styleMap({
              fontSize: this.coordsType === 'lv95' ? '14px' : '16px',
            })}"
            step=${this.coordsType === 'lv95' ? 0.1 : 0.001}
            type="number"
            .value=${this.yValue.toFixed(1)}
            @change="${this.onPositionChange}"
            placeholder="required"
          />
      ...
      <div class="ngm-geom-edit-double-input">
        <div class="ngm-input">
          <input
            ...
            type="number"
            step="0.1"
            .value=${this.heightValue.toFixed(1)}
            @change="${this.onPositionChange}"
            placeholder="required"
          />
