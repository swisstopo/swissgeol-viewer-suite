  ...
  children: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          // Layer "Last glacial maximum 500 (vector)"
          type: LayerType.swisstopoWMTS,
          label: t('lyr_swisstopo_geologie_last_iceage_max_vector500_label'),
      ...
      children: [
        {
          ...
          type: LayerType.swisstopoWMTS,
          label: t('lyr_swisstopo_geophysics_grav_base_network_label') ,
  ...
  children: [
    ...
    },
    {
      ...
      children: [
          ...
          // Layer "Heat flux 500"
          type: LayerType.swisstopoWMTS,
          label: t('lyr_swisstopo_geophysics_heatflux_500_label'),
          ...
          opacity: 0.7,
          queryType: 'geoadmin',
          geocatId: 'd8174b2-8c4a-44ea-b470-cb3f216b90d1',
          legend: 'ch.swisstopo.geologie-geophysik-geothermie',
        },
        {
          // Layer "Temperature model data"
          type: LayerType.swisstopoWMTS,
          label: t('lyr_temperature_model_data_label'),
...
// Top-Level Group "Mineral ressources"
const geo_mineral_resources: LayerTreeNode = {
  label: t('lyr_mineral_ressources_label'),
  children: [
    {
      // Sub-Group I "Construction raw materials"
      label: t('lyr_swisstopo_ressources_construction_minerals_label'),
      children: [
        {
          // Layer "Zementrohstoffe" (aus WMS)
          type: LayerType.swisstopoWMTS,
          label: t('lyr_Zementrohstoffe_label'),
        ...
        {
          // Layer "Hartstein: Produktionsstandorte" (aus WMS)
          type: LayerType.swisstopoWMTS,
          label: t('lyr_Hartstein: Produktionsstandorte_label'),
        ...
        {
          // Layer "Hartstein: Vorkommen" (aus WMTS)
          type: LayerType.swisstopoWMTS,
          label: t('lyr_Hartstein: Vorkommen_label'),
        ...
        {
          // Layer "Felsgebrochene Gesteinskörnungen" (aus WMS)
          type: LayerType.swisstopoWMTS,
          label: t('lyr_Felsgebrochene Gesteinskörnungen_label'),
        ...
        {
          // Layer "Ziegeleirohstoffe" (aus WMTS)
          type: LayerType.swisstopoWMTS,
          label: t('lyr_Ziegeleirohstoffe_label'),
        ...
        {
          // Layer "Naturwerksteine" (aus WMS)
          type: LayerType.swisstopoWMTS,
          label: t('lyr_Naturwerksteine_label'),
        ...
        {
          // Layer "Naturwerksteine an Bauwerken" (aus WMTS)
          type: LayerType.swisstopoWMTS,
          label: t('lyr_Naturwerksteine an Bauwerken_label'),
    ...
    },
    {
      ...
      children: [
          {
          // Layer "Metallrohstoffe" (aus WMS)
          type: LayerType.swisstopoWMTS,
          label: t('lyr_Metallrohstoffe_label'),
