...
import { Credit, ImageryLayer, UrlTemplateImageryProvider, Viewer, WebMapServiceImageryProvider } from 'cesium';
 ...
 */
export function getSwisstopoImagery(localConfig: LayerConfig): Promise<ImageryLayer> {
