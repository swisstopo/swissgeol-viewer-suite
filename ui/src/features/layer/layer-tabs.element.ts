...
export class LayerTabs extends LitElementI18n {
  ...
  readonly render = () => html`
    ${renderTabs(Tab, {
      ...
      panels: {
        [Tab.Catalog]: html`<ngm-layer-catalog .layers=${this.layers}></ngm-layer-catalog>`,
        [Tab.Upload]: html`<ngm-layer-upload .toastPlaceholder=${this.toastPlaceholder}></ngm-layer-upload>`,
